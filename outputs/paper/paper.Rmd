...
abstract: "In this paper, we have fitted a multiple linear regression model to predict the anuual national greenhouse gas (GHG) emission in Canada, and determined that investments in business, machinery equipment, and exports are the economic factors that are contributing the most to Canada's annual GHG emissions. With the current data presented, we are not able to foretell the future trend of Canada's GHG emissions as we cannot quantify how the economy is going to bahave after the pandemic has ended. However, there remains hope as the Government of Canada are actively trying to surpressing the production of GHG, and the innovation of a renewable and green source and energy is imminent. Fulfilling the Paris Agreement (reduce GHG emission levels in 2030 to 30% below the 2005 levels) is the first step toward mitigating the devastating effects of climate change and providing the future generation with a safe world to live in, not a corrupted one."
output:
...
Canada's GDP per capita (@10) and population (@11) is obtained from the World Bank national accounts data, and OECD National Accounts data files. Data on Canada's GDP by expenditure is obtained from Statistics Canada (@12). We have organized the data sets into one as follows. Notice that GDP expenditure have many more sub-categories, here we are only listing a few imporantant ones.
